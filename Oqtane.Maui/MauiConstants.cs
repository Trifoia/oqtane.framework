...
public static class MauiConstants
{
    ...
    public static string ApiUrl = "https://mindboba.azurewebsites.net/"; // for prod development (Oqtane.Server must be already running for MAUI client to connect)
    ...
    public static bool UseAppSettings = false;
}
